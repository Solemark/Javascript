...
const getData = () => [
    ...
    [
        ...
        ['10 x 0 = 0', '10 x 1 = 10', '10 x 2 = 20', '10 x 3 = 30', '10 x 4 = 40', '10 x 5 = 50', '10 x 6 = 60', '10 x 7 = 70', '10 x 8 = 80', '10 x 9 = 90', '10 x 10 = 100', '10 x 11 = 110', '10 x 12 = 120'],
...
test('Calculate multiplication tables', () => {
    let [input, result] = getData()
    for (let i = 0; i < input.length - 1; i++) {
        expect(outputTable(input[i], 12)).toEqual(result[i])
    }
})
